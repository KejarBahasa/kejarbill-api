...
func BuildDependency() (*Dependency, error) {
	...
	settlementService := settlementServicePkg.NewSettlementService(db, settlementRepo, ledgerRepo, groupRepo, groupMemberRepo, groupParticipantRepo, paymentMethodRepo)
